...
public class Enemy : MonoBehaviour
{
    ...
    {
        Debug.Log("vida NORMAL: " + health);
        Debug.Log("menos vida: " + amount);
        health -= amount;
        Debug.Log("Vida nueva: " + health); // Mensaje en la consola
        if (health <= 0)
        {
            Die(); // Llama al método de destrucción
        }
    }
    ...
    void Die()
    {
        ...
        Destroy(gameObject); // Destruye al enemigo cuando su vida es 0
    }
